...
// =============================================================================
// NOTE: All poll CRUD, roster management, and poll-related functions have been
// moved to _07_Models_Poll.gs (Veritas.Models.Poll namespace).
//
// Legacy compatibility wrappers are available in _07_Models_Poll.gs.
// Functions include:
// - Poll CRUD: createNewPoll, updatePoll, deletePoll, copyPoll, duplicateQuestion
// - Poll retrieval: getPollForEditing, getArchivedPolls, getSecureAssessmentBookView
// - Draft management: saveDraft, savePollNew
// - Roster management: saveRoster, bulkAddStudentsToRoster, renameClass, etc.
// - Question normalization: normalizeQuestionObject, normalizeSecureMetadata
// - Image management: uploadImageToDrive
// - Internal helpers: writePollRows, removePollRows, getPolls, etc.
//
// All calls from frontend or other modules route through legacy wrappers.
// =============================================================================

// =============================================================================
// SESSION MANAGEMENT FUNCTIONS
// =============================================================================
// NOTE: All live poll session control, secure assessment management, proctoring,
// and timing functions have been moved to _08_Models_Session.gs
// (Veritas.Models.Session namespace).
//
// Legacy compatibility wrappers are available in _08_Models_Session.gs.
// Functions include:
// - Live Poll Control: startPoll, nextQuestion, previousQuestion, stopPoll,
//   resumePoll, closePoll, pausePollForTimerExpiry
// - Live Poll Results: revealResultsToStudents, hideResultsFromStudents,
//   endQuestionAndRevealResults, resetLiveQuestion
// - Secure Assessment Control: startIndividualTimedSession, endIndividualTimedSession,
//   beginIndividualTimedAttempt, getIndividualTimedSessionState
// - Secure Assessment Student Ops: getIndividualTimedQuestion,
//   initializeIndividualTimedStudent, submitIndividualTimedAnswer,
//   submitAnswerIndividualTimed
// - Secure Assessment Timing: computeSecureTimingState, adjustSecureAssessmentTime,
//   adjustSecureAssessmentTimeBulk, adjustSecureAssessmentTimeForAll
// - Secure Assessment Pause/Resume: pauseSecureAssessmentStudent,
//   resumeSecureAssessmentStudent, forceSubmitSecureAssessmentStudent
// - Secure Assessment Teacher View: getIndividualTimedSessionTeacherView
// - Proctoring: reportStudentViolation, getStudentProctorState,
//   teacherApproveUnlock, teacherBlockStudent, teacherUnblockStudent,
//   studentConfirmFullscreen, ProctorAccess, ProctorTelemetry
// - Session Helpers: buildSecureAssessmentLobbyState, deriveSecureConnectionMeta,
//   applyConnectionMetaToPayload, lookupStudentDisplayName,
//   buildInitialAnswerOrderMap, shuffleArray, hydrateProctorBlockFields
// - Assessment Logging: logAssessmentEvent, resetStudentResponse
//
// All calls from frontend or other modules route through legacy wrappers.
// =============================================================================
...
// =============================================================================
// NOTE: These functions have been moved to _09_Models_Analytics.gs (Batch 4)
// All calls route through legacy compatibility wrappers
// Functions: getStudentInsights, getStudentHistoricalAnalytics,
// getDashboardSummary, getLivePollData, and helper functions
// =============================================================================

// =============================================================================
// ENHANCED ANALYTICS WITH INTERPRETATIONS
// =============================================================================
// NOTE: These functions have been moved to _09_Models_Analytics.gs (Batch 3)
// All calls route through legacy compatibility wrappers
// =============================================================================
...
// NOTE: interpretDifficulty, interpretDiscrimination, and interpretItemQuality
// have been moved to _09_Models_Analytics.gs (Batch 3)
// These functions are available via legacy compatibility wrappers
...
// NOTE: getLivePollData and helper functions (extractStudentNameParts_, formatStudentName_,
// buildSubmittedAnswersMap_, computeAnswerCounts_, computeAnswerPercentages_)
// have been moved to _09_Models_Analytics.gs (Batch 4)
// All calls route through legacy compatibility wrappers
